...
<body>
    ...
    <div class="featuresblue">
        ...
        <h6><strong>Alexander Alexandrov</strong></h6>
                Telefon: +49 170 3029972 <a href="https://wa.me/+491703029972">
        <img src="assets/images/WhatsAppButtonGreenLarge.png" class="whatsapp-button"/></a>
        <a href="assets/Alexander Alexandrov.vcf" target="_blank">speichern</a>
        <br>        <br>

        <img src="assets/alex.png" alt="Qr Image" class="qr-code" style="max-width:20%;">
    ...
    <div class="features" id="small">
        <div class="feature" style="display: inline-grid; text-decoration: none; ">
            <a href="impressum.php"><h6><br>Impressum</a></h6>
            <a href="Datenschutz.php"><h6>Datenschutzerklärung</a></h6>
...
<style>
    .qr-code {
        transition: transform 0.5s; /* Dauer der Animation */
    }

    .qr-code:hover {
        transform: rotate(360deg); /* Rotation beim Hover */
    }
</style>
