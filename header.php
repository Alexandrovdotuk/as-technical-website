...
<head>
    ...
    <link rel="alternate" hreflang="en" href="https://as-technical.de/en/<?php echo basename($_SERVER['PHP_SELF']); ?>" />
    ...
    <script>
        // Hilfsfunktionen zum Setzen und Auslesen von Cookies (für das Banner)
        ...
        // Matomo-Tracking initialisieren
        var _paq = window._paq = window._paq || [];
        _paq.push(['disableCookies']); // Keine Cookies verwenden
        _paq.push(['trackPageView']); // Tracking immer ausführen
        _paq.push(['enableLinkTracking']); // Link-Tracking aktivieren
    ...
    <noscript>
        <p>
            <img referrerpolicy="no-referrer-when-downgrade" src="//as-technical.de/matomo/matomo.php?idsite=1&rec=1" style="border:0;" alt="" />
        </p>
    </noscript>
...
<body>
    <header id="header">
                ...
                <div class="nav-menu-items">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu product-dropdown">
                            <li><a class="dropdown-item" href="downloads.php">Katalog</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu product-dropdown">
                            <li><a class="dropdown-item" href="rauchanlagen.php">Rauchanlagen</a></li>
                            <li><a class="dropdown-item" href="kochkessel.php">Kochkessel</a></li>
                            <li><a class="dropdown-item" href="aufschnittschneidemaschine.php">Aufschnittschneidemaschinen</a></li>
                            <li><a class="dropdown-item" href="fleischwolf.php">Fleischwölfe</a></li>
                            <li><a class="dropdown-item" href="kutter.php">Kutter</a></li>
                            <li><a class="dropdown-item" href="bandsaege.php">Bandsägen</a></li>
                            <li><a class="dropdown-item" href="poekelinjektor.php">Pökelinjektoren</a></li>
                            <li><a class="dropdown-item" href="vakuummischer.php">Feinkostmischer</a></li>
                            <li><a class="dropdown-item" href="speckschneider.php">Würfelschneidemaschinen</a></li>
                            <li><a class="dropdown-item" href="abschwarter.php">Entschwartungsmaschine</a></li>
                            <li><a class="dropdown-item" href="darmschweissgeraet.php">Darmschweißgerät</a></li>

                            <li><a class="dropdown-item" href="dusche.php">Kühlsysteme</a></li>
                            <li><a class="dropdown-item" href="wuerstchentrennmaschine.php">Würstchentrenner</a></li>
                            <li><a class="dropdown-item" href="waschautomaten.php">Waschautomaten</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu product-dropdown">
                            <li><a class="dropdown-item" href="konvektomat.php">Kombidämpfer</a></li>
                            <li><a class="dropdown-item" href="kuehltechnik.php">Kühltechnik</a></li>

                            <li><a class="dropdown-item" href="verpackungsmaschinen.php">Verpackungsmaschinen</a></li>
                            <li><a class="dropdown-item" href="hygienetechnik.php">Hygienetechnik</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu product-dropdown">
                            <!--<li><a class="dropdown-item" href="gebrauchte_rauchanlagen.php">Räucheranlagen</a></li>-->
                            <li><a class="dropdown-item" href="gebrauchte-abschwarter.php">Abschwarter</a></li>
                            <li><a class="dropdown-item" href="gebrauchte-feinkostmischer.php">Feinkostmischer</a></li>
                            <li><a class="dropdown-item" href="gebrauchte-fleischwolf.php">Fleischwolf</a></li>
                            <li><a class="dropdown-item" href="gebrauchte-injektor.php">Pökelinjektor</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu product-dropdown">
                            <li><a class="dropdown-item" href="dienstleistungen.php">Unsere Leistungen</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu product-dropdown">
                            <li><a class="dropdown-item" href="kontaktformular.php">Kontaktformular</a></li>
                        </ul>
                    </li>
                </div>
                <div class="scroll-hint">Nach unten scrollen</div>
            </ul>
        ...
        <div id="cookie-banner">
            <p>
                Wir verwenden Cookies, um Ihre Interaktionen auf unserer Website zu erfassen. So können wir unser Angebot kontinuierlich verbessern und besser auf Ihre Bedürfnisse abstimmen. Weitere Informationen finden Sie in unserer <a href="Datenschutz.php">Datenschutzerklärung</a>.
            </p>
        ...
        <div class="social-fixed">
            <a href="https://www.instagram.com/astechnicalsolution/" target="_blank" rel="noopener noreferrer" class="instagram-btn">
