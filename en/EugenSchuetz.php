...
<footer>
    <div class="featuresblue">
        ...
        <div class="feature">
            ...
            <a href="../assets/Eugen Schuetz.vcf" target="_blank">Save Contact</a>
            <br>
            <br>
            <img src="../assets/eugenschuetz.svg" alt="QR Code for Contact" class="qr-code" style="max-width:10%;">
        </div>
        <div class="feature">
