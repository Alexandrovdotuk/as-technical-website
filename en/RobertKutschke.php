    ...
    <footer>
        <div class="featuresblue">
            ...
            <div class="feature">
                ...
                Phone: +49 160 91658700
                <a href="https://wa.me/+4916091658700">
                    <img src="../assets/images/WhatsAppButtonGreenLarge.png" class="whatsapp-button" alt="WhatsApp Contact Button" />
                </a>
                <a href="../assets/Robert Kutschke.vcf" target="_blank">Save Contact</a>
                <br>
                <br>
                <img src="../assets/robertkutschke.png" alt="QR Code for Contact" class="qr-code" style="max-width:20%;">
            </div>
            <div class="feature">
