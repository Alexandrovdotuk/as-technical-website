...
$PAYPAL_CLIENT_ID = getenv("AWsmog-fSL3oSkpSxMIjimOulWp7k-_KzDrAjKWt7wk5DEe_bx1vcM77iHz2UR0r_NpGjg1PDy0uOOxZ");
$PAYPAL_CLIENT_SECRET = getenv("EOn9W-5zwcSy4Z3YljcFkwriQaobgT9vs8H7sG3rxxpBGCycrlKeraHn_joLqjlM6xHdmcI1Oe7q5MxZ");
    ...
    $orderBody = [
        "body" => OrderRequestBuilder::init("CAPTURE", [
            PurchaseUnitRequestBuilder::init(
                AmountWithBreakdownBuilder::init("EUR", "9,90")
                    ->breakdown(
                        AmountBreakdownBuilder::init()
                            ->itemTotal(
                                MoneyBuilder::init("EUR", "9,90")->build()
                            )
                            ->build()
                    )
                    ->build()
