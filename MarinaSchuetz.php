<?php include 'header.php' ?>
    ...
    <script>
        window.onload = function() {
            // Pfad zur VCF-Datei
            var vcfFilePath = 'assets/marinaschuetz.vcf';
    ...
    <footer>
        <div class="featuresblue">
            ...
            <div class="feature">
                ...
                <br>
                <h6><strong>Marina Schütz</strong></h6>
                Telefon: +49 17680667819
                <a href="https://wa.me/+4917680667819">
                    <img src="assets/images/WhatsAppButtonGreenLarge.png" class="whatsapp-button" />
                </a>
                <a href="assets/marinaschuetz.vcf" target="_blank">speichern</a>
                <br>
                <br>
                <img src="assets/marinaschuetz.svg" alt="Qr Image" class="qr-code" style="max-width:10%;">
            </div>
            <div class="feature">
                <h5><strong>E-Mail</strong></h5>
                <h6><a href="mailto:m.schuetz@as-technical.de">m.schuetz@as-technical.de</a></h6>
            </div>
        </div>
